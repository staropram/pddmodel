...
title: Varying differences between police forces (2x impact)
---
...
png(filename = "figures/reoffending_vs_pf_2x.png", width = 600, height = 600)
...
# save it to PNG
savedPlot <- recordPlot()
png(filename = "figures/rehab_vs_pf_2x.png", width = 600, height = 600)
replayPlot(savedPlot)
invisible(dev.off())
```
...
# save it to PNG
savedPlot <- recordPlot()
png(filename = "figures/hospital_vs_pf_2x_g1.png", width = 600, height = 600)
replayPlot(savedPlot)
invisible(dev.off())
```
...
# save it to PNG
savedPlot <- recordPlot()
png(filename = "figures/hospital_vs_pf_2x_g2.png", width = 600, height = 600)
replayPlot(savedPlot)
invisible(dev.off())
```
